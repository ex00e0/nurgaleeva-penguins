...
<head>
    ...
    <style>
       @font-face {src: url("fonts/Lato-Heavy.woff");
      font-family:"Lato Heavy";}
      @font-face {src: url("fonts/Lato-Regular.woff");
      font-family:"Lato";}
        * {margin: 0;
          padding: 0;
          font-size: 100%;}
        header {height:13.5vmax;
                width:100%;
                display:grid;
                grid-template-rows: 27% 1fr 27%;
                grid-template-columns:8% 1fr 8%;}
        #firstLine {grid-row:1;
                    grid-column:2;
                   display:grid;
                   grid-template-rows:100%;
                   border-bottom:0.15vmax solid #D9DADB;
                   grid-template-columns: 10% 4% 1% 1fr 14.3% 5% 1.5% 1% 4%;}
        #menuBlock {grid-column:1;
                   grid-row:1;
                   display:grid;
                   grid-template-columns: 20% 13% 1fr;
                   grid-template-rows: 100%;
                   align-items: center;
                   border-right: 0.15vmax solid #D9DADB;}
        #menu {width:100%;}
        #sections {grid-column:3;
                   color: #262D33;
                   font-family:"Lato Heavy";
                   font-size:1.15vmax;
                   width:100%;}
        #iconSearch {justify-self:end;
                     width:40%;
                     grid-column:2;
                     align-self:center;}
        #search {grid-column:4;
                ...
                font-size:1.15vmax;
                font-family:"Lato";}
        #subscribeBlock {grid-column:5;
                         display:grid;
                         grid-template-columns: 30% 1fr;
                         grid-template-rows: 100%;}
        #iconSignIn {grid-column:7;
                     width:100%;
                     align-self:center;}
        #signIn {grid-column:9;
                 align-self:center;
                 color:#4B5157;
                 font-family:"Lato";
                 font-size: 1.15vmax;}
        #secondLine {grid-row:2;
                    grid-column:2;
                   display:grid;
                   grid-template-rows:100%;
                   align-items:center;
                   grid-template-columns: 1fr 19% 2% 0.7% 4.3%;}
        #nameCompany {grid-row:1;
        ...
        #temp {grid-column:5;
               ...
               font-size:1.15vmax;
               font-family: "Lato";}
        #thirdLine {grid-column:1/span all;
                    grid-row:3;
                    background-color: #262D33;
                    display:grid;
                    grid-template-columns: 8% auto 8%;
                    grid-template-rows: 100%;}
        #catBlock {grid-column:2;
                   color:white;
                   display:flex;
                   align-items: center;
      ...
      #formGrid {display:grid;
                       ...
                       grid-template-columns: 8% 1fr 8%;
                       height:30vmax;}
        #headlineForm {color:#262D33;
                   grid-column:2;
                   font-size:2vmax;
                   font-family:"Lato Heavy";}   
        form {display:grid;
              grid-column:2;
              grid-template-rows: 7% 7% 3% 7% 7% 3% 7% 25% 3% 7% 7% 3% 1fr;
              grid-template-columns: 100%;
              width:70%;}  
        form label {color:#4B5157;
                    font-family: "Lato";
                    font-size:1.15vmax;}  
        input:not(#newImage, #buttonForm), textarea, select {padding-left: 3%;
                         width:100%;
                         box-sizing: border-box;
                         color:#4B5157;
                         font-family:"Lato";
                         font-size:0.95vmax;
                         border:0.15vmax solid #D9DADB;
                         border-radius:0.4vmax;}
        textarea {padding-top:1%;}
        #labelImage {grid-row:4;}
        #newImage {grid-row:5;}
        #newText {grid-row:8/9; 
                 overflow-y:scroll;}
        #labelText {grid-row:7;}
        #newCategory {grid-row:11;}
        #labelCategory {grid-row:10;}
        #buttonForm {grid-row:13;
...
<header>
  ...
  <div id="secondLine">
     ...
     <div id="date">Вторник, 16 января, 2024</div>
...
<div class="void"></div>
<div id="headlineGrid">
  <div id="headlineForm">Создание новости</div>
</div>

<div class="void2"></div>
<div id="formGrid">
  <form method="post" action="createNewValid.php" enctype="multipart/form-data">
